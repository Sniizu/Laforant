...
;(function ($){
	...
	$(window).on('load', function () {
		$('#preloader-js').delay(0).fadeOut();
		$('#web-preloader-js').delay(200).fadeOut('slow');
	});
	$.fn.exists = function () {
	...
	var gmap = $('.gm-map');
	var testiSlick = $('.js-agents-slick');
	...
	var Core = {
		...
		headerNav: function () {
			...
			if (mainNav.exists()) {
				...
				var wrapper = $('.website-body');
				var navList = $('.main-nav-list');
				var navListLi = $('.main-nav-list > li');
				var toggleBtn = $('#header-mobile-menu');

				var navLogin = $('.nav-right-signin').clone();
				navLogin.appendTo(navList);

				toggleBtn.on('click', function (){
					wrapper.toggleClass('website-body--has-overlay');
				...
				$('.site-overlay').on('click', function (e){
					e.preventDefault();
					wrapper.removeClass('website-body--has-overlay-pushy website-body--has-overlay');
				});

				navListLi.has('.main-nav-sub').addClass('has-children').prepend('<span class="main-nav__toggle"></span>');
				...
				$('.main-nav__toggle').on('click', function (){
					...
					$('.main-nav-sub, .main-nav__megamenu').not($(this).siblings('.main-nav-sub, .main-nav__megamenu')).slideUp('normal');
					$(this).siblings('.main-nav-sub').slideToggle('normal');
					$(this).siblings('.main-nav__megamenu').slideToggle('normal');
				});

				$('.main-nav-list > li > ul > li').has('.main-nav-sub-2').addClass('has-children').prepend('<span class="main-nav__toggle-2"></span>');
				$('.main-nav-list > li > ul > li > ul > li').has('.main-nav-sub-3').addClass('has-children').prepend('<span class="main-nav__toggle-2"></span>');

				$('.main-nav__toggle-2').on('click', function (){
					$(this).toggleClass('main-nav__toggle--rotate');
					$(this).siblings('.main-nav-sub-2').slideToggle('normal');
					$(this).siblings('.main-nav-sub-3').slideToggle('normal');
				});
